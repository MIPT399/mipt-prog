...
class Point(Storeable):
    ...
    def store(self):
        return dumps({'x' : self.x, 'y' : self.y})
...
class Unit(Storeable):
    ...
    def store(self):
        return dumps({'id':self.id, 'position':self.position, 'health':self.health})
...
class Response(Storeable):
    ...
    def store(self):
        return dumps({'result' : self.result, 'cause' : self.cause})
...
class Action(Storeable):
    ...
    def store(self):
        return dumps({'id' : self.id, 'position' : self.position})
